 ...
 * space units, when
 * the raster space can be embedded in the model space coordinate system without
 * rotation, and
 ...
 * pixels. The ScaleZ is
 * primarily used to map the pixel value of a digital elevation model into the
 * correct Z-scale, and
 * so for most other purposes this value should be zero (since most model spaces
 * are 2-D, with Z=0).
 *
 * <p>
